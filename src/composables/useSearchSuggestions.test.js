...
describe('AIS autocomplete API integration', () => {
  ...
  it('returns address suggestions for a typed prefix', async () => {
    ...
    const url = `https://0spy4bb9w1.execute-api.us-east-1.amazonaws.com/queryAis/autocomplete?q=${encodeURIComponent(query)}&simple=true&client_id=${import.meta.env.VITE_DEBUG ? import.meta.env.VITE_AIS_CLIENTID_OEMFLOOD : ''}`
